...
做 adversarial pass 時：challenger 提交必須含 challenged_claim_id、specific_objection、supporting_evidence_or_reasoning（新證據，或具體可查核的方法論問題如分母錯誤、selection bias、反向因果、identification 不成立）、origin、entailment、why_it_changes_claim。空泛「可能有其他解釋」直接 discard。裁決看 provenance、測量品質、entailment、獨立性、時效、解釋力，不看票數。論點不再推進就停；停火標 GENUINELY_UNCERTAIN 並寫下何種證據可解。異議原文寫進「核心爭議」區。
